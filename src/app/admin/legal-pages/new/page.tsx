...
import { z } from "zod";
import { FiArrowLeft, FiSave, FiBold, FiItalic, FiList, FiLink, FiGlobe, FiPlusCircle } from "react-icons/fi";
import Link from "next/link";
import { useCreateLegal } from "@/hooks/useLegals";
...
export default function NewLegalPage() {
  ...
  const createMutation = useCreateLegal();
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      successAlert("Page Created", "The legal page has been created successfully.");
      router.push("/admin/legal-pages");
    } catch (err: any) {
      errorAlert("Creation Failed", err.message || "Failed to create legal page.");
    }
  };
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-slate-900">Create Legal Page</h1>
          <p className="text-xs text-muted-foreground">Publish terms, conditions, privacy rules, or cookie guidelines.</p>
        </div>
      </div>
            ...
            <CardContent className="bg-white border rounded-2xl p-6 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  placeholder="<h2>Section 1</h2><p>Provide detailed policy terms here...</p>"
                  rows={14}
              ...
              <div className="flex items-center gap-2">
                ...
                <label htmlFor="isPublished" className="text-sm font-medium text-slate-700 cursor-pointer">
                  Publish this page immediately (visible to public)
                </label>
              </div>
            </CardContent>
          </TabsContent>
            ...
            <CardContent className="bg-white border rounded-2xl p-6 space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="canonicalUrl"
                    placeholder="https://insaniatparjatan.com/terms-of-service"
                    className="border-slate-200"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  id="seoDescription"
                  placeholder="Brief summary showing in search results..."
                  rows={2}
              ...
              <div className="border-t pt-4 mt-4 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    id="ogDescription"
                    placeholder="Short description when shared on social channels..."
                    rows={2}
                    className="w-full rounded-xl border border-slate-200 p-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-700"
        ...
        <div className="flex justify-end gap-3 pt-6 border-t mt-6">
          ...
          >
            {createMutation.isPending ? (
              ...
              <>
                <FiSave className="h-4 w-4" /> Create Page
              </>
            )}
          </Button>
        </div>
